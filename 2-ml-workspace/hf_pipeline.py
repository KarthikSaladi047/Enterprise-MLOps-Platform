...
def train_and_register(
    ...
    print(f"Starting training for {epochs} epochs (lr={learning_rate}, batch_size={batch_size})...")
    ...
    # 5. Log to MLflow (always) and register to the Model Registry (only for final runs)
    ...
    with mlflow.start_run():
        ...
        if register_model:
            ...
            print(f"Trial complete. final_loss={avg_loss:.4f} (model not registered)")
...
def mlops_pipeline(
    ...
    # Step 2: Train the model (and register it, since this is the production pipeline)
